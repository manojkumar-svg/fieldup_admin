...
const venueSports = [
  { venueId: 'a1000000-0000-0000-0000-000000000001', sportType: 'CRICKET_NET', numberOfCourts: 3, pricePerHour: 1500, openTime: '06:00', closeTime: '22:00', availableDays: ['MON','TUE','WED','THU','FRI','SAT','SUN'], rules: 'White ball only during night sessions', amenities: ['Nets','Bowling Machine'] },
  ...
  { venueId: 'a1000000-0000-0000-0000-000000000002', sportType: 'SNOOKER', numberOfCourts: 2, pricePerHour: 700, openTime: '07:00', closeTime: '21:00', availableDays: ['MON','TUE','WED','THU','FRI','SAT'], rules: null, amenities: [] },
  ...
  { venueId: 'a1000000-0000-0000-0000-000000000005', sportType: 'CRICKET_NET', numberOfCourts: 5, pricePerHour: 1200, openTime: '06:00', closeTime: '21:00', availableDays: ['MON','TUE','WED','THU','FRI','SAT','SUN'], rules: 'Helmets compulsory in nets', amenities: ['Practice Nets','Bowling Machine','Video Analysis'] },
  ...
  { venueId: 'a1000000-0000-0000-0000-000000000007', sportType: 'VOLLEYBALL', numberOfCourts: 5, pricePerHour: 800, openTime: '07:00', closeTime: '19:00', availableDays: ['MON','TUE','WED','THU','FRI','SAT','SUN'], rules: null, amenities: ['Volleyball','Net'] },
  { venueId: 'a1000000-0000-0000-0000-000000000008', sportType: 'BOXING', numberOfCourts: 2, pricePerHour: 500, openTime: '06:00', closeTime: '21:00', availableDays: ['MON','TUE','WED','THU','FRI','SAT'], rules: 'Wraps and gloves mandatory', amenities: ['Gloves','Wraps','Head Guard'] },
...
const courts = [
  { id: 'c1000000-0000-0000-0000-000000000001', venueId: 'a1000000-0000-0000-0000-000000000001', name: 'Cricket Net 1', description: 'Outdoor cricket practice net', address: '123 Sports Complex Road, Andheri West', city: 'Mumbai', state: 'Maharashtra', pincode: '400053', latitude: 19.1364, longitude: 72.8296, sportType: 'CRICKET_NET', surfaceType: 'TURF', indoor: false, pricePerHour: 1500, maxPlayers: 6, capacity: 6, amenities: ['Nets','Bowling Machine'], openTime: '06:00', closeTime: '22:00', status: 'ACTIVE' },
  { id: 'c1000000-0000-0000-0000-000000000002', venueId: 'a1000000-0000-0000-0000-000000000001', name: 'Cricket Net 2', description: 'Outdoor cricket practice net', address: '123 Sports Complex Road, Andheri West', city: 'Mumbai', state: 'Maharashtra', pincode: '400053', latitude: 19.1364, longitude: 72.8296, sportType: 'CRICKET_NET', surfaceType: 'TURF', indoor: false, pricePerHour: 1500, maxPlayers: 6, capacity: 6, amenities: ['Nets'], openTime: '06:00', closeTime: '22:00', status: 'ACTIVE' },
  { id: 'c1000000-0000-0000-0000-000000000003', venueId: 'a1000000-0000-0000-0000-000000000001', name: 'Cricket Net 3 (Indoor)', description: 'Indoor cricket practice net with synthetic surface', address: '123 Sports Complex Road, Andheri West', city: 'Mumbai', state: 'Maharashtra', pincode: '400053', latitude: 19.1364, longitude: 72.8296, sportType: 'CRICKET_NET', surfaceType: 'SYNTHETIC', indoor: true, pricePerHour: 1800, maxPlayers: 6, capacity: 6, amenities: ['Nets','AC'], openTime: '06:00', closeTime: '22:00', status: 'ACTIVE' },
  ...
  { id: 'c1000000-0000-0000-0000-000000000010', venueId: 'a1000000-0000-0000-0000-000000000002', name: 'Snooker Table 1', description: 'Indoor snooker table with wooden flooring', address: '45 Racket Lane, Koramangala', city: 'Bangalore', state: 'Karnataka', pincode: '560034', latitude: 12.9352, longitude: 77.6245, sportType: 'SNOOKER', surfaceType: 'WOODEN', indoor: true, pricePerHour: 700, maxPlayers: 2, capacity: 2, amenities: [], openTime: '07:00', closeTime: '21:00', status: 'ACTIVE' },
...
const academies = [
  { id: 'b1000000-0000-0000-0000-000000000001', name: 'Champions Sports Academy', description: 'Multi-sport academy producing national-level athletes since 2010', sportsOffered: ['CRICKET_NET','FOOTBALL'], address: '100 Academy Boulevard, Shivaji Nagar', city: 'Mumbai', state: 'Maharashtra', pincode: '400002', latitude: 19.0178, longitude: 72.8478, contactPhone: '+91-9876543020', contactEmail: 'info@champions-academy.com', website: 'https://champions-academy.com', establishedYear: 2010, status: 'ACTIVE' },
...
const trainers = [
  { id: 'd1000000-0000-0000-0000-000000000001', name: 'Rahul Sharma', email: 'rahul.sharma@example.com', phone: '+91-9876543030', sportSpecialization: 'CRICKET_NET', experience: 12, certifications: ['BCCI Level 3','NCA Certified'], hourlyRate: 1200, bio: 'Former Ranji Trophy player with 12 years coaching experience. Specialises in batting technique.', city: 'Mumbai', state: 'Maharashtra', status: 'ACTIVE' },
  ...
  { id: 'd1000000-0000-0000-0000-000000000007', name: 'Arjun Deshmukh', email: null, phone: '+91-9876543036', sportSpecialization: 'CRICKET_NET', experience: 8, certifications: ['BCCI Level 2','NCA Fast Bowling'], hourlyRate: 1000, bio: 'Fast bowling specialist. Coached 3 IPL net bowlers.', city: 'Pune', state: 'Maharashtra', status: 'ACTIVE' },
  ...
  { id: 'd1000000-0000-0000-0000-000000000011', name: 'Deepak Chauhan', email: null, phone: '+91-9876543040', sportSpecialization: 'BOXING', experience: 14, certifications: ['BJJ Purple Belt','Muay Thai Kru'], hourlyRate: 1300, bio: 'Professional boxing and combat sports coach.', city: 'Kolkata', state: 'West Bengal', status: 'ACTIVE' },
  ...
  { id: 'd1000000-0000-0000-0000-000000000013', name: 'Suresh Menon', email: 'suresh.m@example.com', phone: '+91-9876543042', sportSpecialization: 'SNOOKER', experience: 11, certifications: ['WSF Level 2','SRFI Certified'], hourlyRate: 950, bio: 'National snooker champion 2015. Coaching competitive players.', city: 'Mumbai', state: 'Maharashtra', status: 'ACTIVE' },
