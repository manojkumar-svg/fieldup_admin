...
export default function NewYogaStudioPage(): React.ReactElement {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: YogaStudioInput) => {
      const res = await fetch('/api/yoga-studios', {
        method: 'POST',
      ...
      if (!res.ok) {
        ...
        throw new Error(err.error?.message ?? 'Failed to create yoga studio');
      }
      return res.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['yoga-studios'] });
      toast('Yoga studio created successfully', 'success');
  ...
  return (
    <div>
      <PageHeader title="Add Yoga Studio" backHref="/dashboard/yoga-studios" />
